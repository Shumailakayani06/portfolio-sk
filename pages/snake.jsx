...
const Holidaze = () => {
  return (
    <>
    <Head>
    <title>Portfolio | Snake Game</title>
       ...
       <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
         <div className='col-span-4'>
           ...
           <ul className='grid grid-cols-1 md:grid-cols-1'>
            <li className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill  className='pr-1'/></li>
            <li className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill  className='pr-1'/></li>
            <li className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill  className='pr-1'/></li>
            <li className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill  className='pr-1'/></li>
            ...
            <a 
             href='https://cheerful-puppy-2001bb.netlify.app/'>
            <button className='px-8 py-2 mt-4 mr-8'>Demo</button>
            </a>
            <a
            href='https://github.com/Shumailakayani06/snake-game'>
