...
import holidazeImg from '../public/assets/holidazeImg.png'
...
const Holidaze = () => {
  return (
    <>
    <Head>
    <title>Portfolio | Holidaze</title>
    ...
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Holidaze</h2>
                <h3>HTML / CSS / Next.js / Strapi</h3>
            </div>
        </div>
       ...
       <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
         <div className='col-span-4'>
           ...
           <ul className='grid grid-cols-1 md:grid-cols-1'>
            ...
            <a
            href='https://github.com/Noroff-FEU-Assignments/project-exam-2-Shumailakayani06'>
