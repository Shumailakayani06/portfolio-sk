...
import beautyStoreImg from '../public/assets/beautystore.png'
...
const BeautyStore = () => {
  return (
    <>
       <Head>
        <title>Portfolio | Beauty Store</title>
    ...
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Beauty Store</h2>
                <h3>HTML / CSS / JavaScript / Strapi</h3>
            </div>
        </div>
